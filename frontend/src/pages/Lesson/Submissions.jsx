...
export default function Submissions() {
  ...
  return (
    <>
      <div className="grid md:hidden justify-items-center place-items-center w-full h-full px-5">
        <h1 className="text-black font-extrabold text-xl text-[#1F4068]">
          NOT AVAILABLE ON MOBILE !
        </h1>
      </div>

      <div className="hidden md:grid w-full h-auto min-h-screen grid-cols-[2.5fr_1fr] md:grid-cols-[2fr_1fr] gap-x-5">
        
        {/* RIGHT SIDE – File View and Grading */}
        <div className="grid grid-rows-[4fr_1fr] 2xl:grid-rows-[5fr_1fr]">
          <div className="flex justify-center items-center">
            ...
            <p className="text-[#102E50] self-center font-extrabold text-xl
                  2xl:text-4xl"
            >
        ...
        <div className="p-4 overflow-y-auto flex flex-col gap-4 bg-[#1F4068]/90">
          ...
          {currentSubmissions.length > 0 ? (
            ...
            <p className="text-white/90 text-lg mt-5">No submissions found.</p>
          )}
